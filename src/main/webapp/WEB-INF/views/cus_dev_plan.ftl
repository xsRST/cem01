...
<table id="dg" title="开发计划项" style="width:700px;height:250px"
    ...
    <tr>
        ...
        <th field="planDate" width="100" editor="{type:'datebox',options:{required:true}}">计划日期</th>
        <th field="planItem" width="100" align="right" editor="{type:'text',options:{required:true}}">计划内容</th>
        <th field="exeAffect" width="100" align="right" editor="{type:'text',options:{required:true}}">执行效果</th>
    </tr>
    </thead>
</table>
<div id="toolbar">
